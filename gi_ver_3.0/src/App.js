...
var cards2 = generateRandomSet(cards, 5)
  ...
  return (
    <div className="App">
      ...
      <HandCard num={1} cards={cards1} rotation={"rotation"}/>
      <MonsterZone num={1} characters={characters1} rotation={"rotation"}/>
      <MonsterZone num={2} characters={characters2} rotation={""}/>
      <HandCard num={2} cards={cards2} rotation={""}/>
    </div>
  );
}
